 ...
 * 功能：应用启动引导页面，展示品牌标识、今日轨迹预览和核心特性介绍。
 * 3秒后自动跳转至登录页，点击任意位置可跳过。
 *
 * @source 拆分自 components/TraceJourneyScreens.tsx (SCREEN 14)
 */
import { useState, useEffect } from 'react';
import { miniToast } from '../../utils';
import { ScreenId } from '../../types';
import { useI18n } from '../../i18n';
import { Route, Activity, Timer } from 'lucide-react';
